...
<body>
	<%--
		empty 연산자
			형식) empty 값
				1. 값이 비어 있거나 null 인지를 조사할 때 사용하는 연산자 이다.
				2. 값이 null 이면 true 를 반환한다.
				3. 문자열과 배열의 크기가 0인 경우에도 true 를 반환한다.
	 --%>
	 ...
	 <h3>\${null==fodd2}=${null==food2}</h3>
	 
	 <%-- name 이라는 파라미터가 존재하지 않을 경우 아무것도 출력되지 않는다 --%>
