 ...
 */
//web.xml 에서 해당 서블릿 클래스를 호출하는 url-pattern 을 지정하는게 아니라 어노테이션으로 바로 지정할 수 있다. => (프로젝트 폴더명)/urlpattern 지정할 문자열
@WebServlet(urlPatterns= "/time")
public class ServletTest2 extends jakarta.servlet.http.HttpServlet {
	...
	public void doGet(HttpServletRequest request, 
		...
		out.write("<BODY style='background:mistyrose'><H1>");
		out.write("현재시각은 ");
