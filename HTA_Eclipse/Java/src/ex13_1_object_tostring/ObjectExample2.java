...
public class ObjectExample2 {
	...
	public static void main(String args[]) {
		...
		System.out.println(obj1.toString());// ex13_1_Object_toString.Circle@24d46ca6
		//System.out.print() 나 System.out.println() 메서드에 
		//객체를 넘겨주면 toString()메서드가 호출된다.
		System.out.println(obj1);// ex13_1_Object_toString.Circle@24d46ca6

		System.out.println(obj2.toString());// ex13_1_Object_toString.Circle@4517d9a3
		System.out.println(obj2);// ex13_1_Object_toString.Circle@4517d9a3
	}
}
