...
public class StringExample7 {
	...
	public static void main(String[] args) {
		...
		System.out.println("=============trim() : 문자열 앞뒤 공백 제거 =============");
		...
		System.out.println("=======toUpperCase() : 대문자로 전환 ====");
		System.out.println(str2.toUpperCase());
		System.out.println(str2+"\n");
		
		System.out.println("=======toLowerCase() : 소문자로 전환 ====");
		...
		//본래 System.out.println(참조형변수)인데
		// System.out.println(str2.toString()) 으로 변환해서 출력하는 과정을 생략한 것이다.
