 ...
 * 초기화 블럭을 포함하는 클래스의 예
 * 멤버변수(필드) 의 초기화 방법
 * 1. 명시적 초기화 = 변수 선언과 동시에 초기화되는것 (간단명료)
...
public class HundredNumbers2 {
	...
	/*
	 * 클래스 초기화(정적 초기화) 블럭 시작
	 * 클래스가 사용되기 전에 단 한번 호출(정적필드 초기화에 주로 사용된다)
	 */
	static {
		System.out.println("클래스 초기화 블럭 시작");
		...
		System.out.println();
		System.out.println("클래스 초기화 블럭 종료");
	...
	//인스턴스 초기화 블럭 :
	{
		...
		System.out.println("인스턴스 초기화 블럭 종료");
